...
public class SwipeBall2 : MonoBehaviour
{
    ...
    public float appearBall1 = 0;
    public GameObject ball2;
    public bool enemyShooting = false;
    public bool appearBall1Bool = false;
    //Start
    void Start()
    {
        startTime = Time.time;
    ...
    void Update()
    {
        ...
        {
            //rb.AddForce(Vector3.forward * 500, ForceMode.Acceleration);
        }
